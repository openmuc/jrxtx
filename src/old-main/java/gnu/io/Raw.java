...
final class Raw extends RawPort {
    ...
    private native void nativeSetRawPortParams(int speed, int dataBits, int stopBits, int parity)
    ...
    public void sendEvent(int event, boolean state) {
        ...
        case RawPortEvent.OUTPUT_BUFFER_EMPTY:
            ...
            return;
        /*
         * if( monThread.DSR ) break; return; if (isDSR()) { if (!dsrFlag) { dsrFlag = true; RawPortEvent e = new
         * RawPortEvent(this, RawPortEvent.DSR, !dsrFlag, dsrFlag ); } } else if (dsrFlag) { dsrFlag = false;
