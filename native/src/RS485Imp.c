...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_gnu_io_RS485Port_open(JNIEnv *env, jobject jobj,
		jstring jstr) {
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_gnu_io_RS485Port_isCD(JNIEnv *env, jobject jobj) {
	unsigned int result = 0;
	int fd = get_java_var(env, jobj, "fd", "I");
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_gnu_io_RS485Port_isRI(JNIEnv *env, jobject jobj) {
	unsigned int result = 0;
	int fd = get_java_var(env, jobj, "fd", "I");
...
JNIEXPORT jint JNICALL Java_gnu_io_RS485Port_getInputBufferSize(JNIEnv *env,
jobject jobj) {
#ifdef DEBUG
...
JNIEXPORT jint JNICALL Java_gnu_io_RS485Port_getOutputBufferSize(JNIEnv *env,
jobject jobj) {
#ifdef DEBUG
