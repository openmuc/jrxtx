...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_gnu_io_RawPort_open(JNIEnv *env, jobject jobj,
		jint ciAddress) {
	if (ioperm(ciAddress, 3, 1))
		goto fail;
	return (0);
	fail: throw_java_exception(env, IO_EXCEPTION, "open", strerror( errno));
	return -1;
}
...
JNIEXPORT jint JNICALL Java_gnu_io_RawPort_nativeClose(JNIEnv *env,
	...
	if (ioperm(ciAddress, 3, 0))
		goto fail;
	return (0);
	fail: throw_java_exception(env, IO_EXCEPTION, "close", "failed");
	return -1;
}
...
/*----------------------------------------------------------
 ...
 exceptions:  none
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_Bus_read8(JNIEnv * env, jobject poObj, jint piPort) {
...
/*----------------------------------------------------------
 ...
 exceptions:  none
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_Bus_read16(JNIEnv * env, jobject poObj, jint piPort) {
...
/*----------------------------------------------------------
 ...
 exceptions:  none
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_Bus_read32(JNIEnv * env, jobject poObj, jint piPort) {
...
int translate_speed(JNIEnv *env, jint speed) {
	...
	throw_java_exception(env, UNSUPPORTED_COMM_OPERATION, "translate_speed",
			"speed");
	return 0;
}
...
int translate_data_bits(JNIEnv *env, int *cflag, jint dataBits) {
	...
	throw_java_exception(env, UNSUPPORTED_COMM_OPERATION, "translate_data_bits",
			"data bits");
	return 0;
}
...
int translate_stop_bits(JNIEnv *env, int *cflag, jint stopBits) {
	...
	throw_java_exception(env, UNSUPPORTED_COMM_OPERATION, "translate_stop_bits",
			"stop bits");
	return 0;
}
...
int translate_parity(JNIEnv *env, int *cflag, jint parity) {
	...
	throw_java_exception(env, UNSUPPORTED_COMM_OPERATION, "translate_parity",
			"parity");
	return 0;
}
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_gnu_io_RawPort_NativegetReceiveTimeout(JNIEnv *env,
		jobject jobj) {
	int fd = get_java_var(env, jobj, "fd", "I");
	struct termios ttyset;
	...
	fail: throw_java_exception(env, IO_EXCEPTION, "getReceiveTimeout",
			strerror( errno));
	return -1;
}
...
JNIEXPORT jboolean JNICALL Java_gnu_io_RawPort_NativeisReceiveTimeoutEnabled(
	...
	fail: throw_java_exception(env, IO_EXCEPTION, "isReceiveTimeoutEnabled",
			strerror( errno));
	return JNI_FALSE;
}
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_gnu_io_RawPort_isDSR(JNIEnv *env, jobject jobj) {
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_gnu_io_RawPort_isCD(JNIEnv *env, jobject jobj) {
	unsigned int result = 0;
	int fd = get_java_var(env, jobj, "fd", "I");
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_gnu_io_RawPort_isCTS(JNIEnv *env, jobject jobj) {
	unsigned int result = 0;
	int fd = get_java_var(env, jobj, "fd", "I");
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_gnu_io_RawPort_isRI(JNIEnv *env, jobject jobj) {
	unsigned int result = 0;
	int fd = get_java_var(env, jobj, "fd", "I");
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_gnu_io_RawPort_isRTS(JNIEnv *env, jobject jobj) {
	unsigned int result = 0;
	int fd = get_java_var(env, jobj, "fd", "I");
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL Java_gnu_io_RawPort_isDTR(JNIEnv *env, jobject jobj) {
	unsigned int result = 0;
	int fd = get_java_var(env, jobj, "fd", "I");
...
/*----------------------------------------------------------
 ...
 exceptions:  IOException
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_gnu_io_RawPort_readByte(JNIEnv *env, jobject jobj) {
	int bytes;
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL Java_gnu_io_RawPort_readArray(JNIEnv *env, jobject jobj,
	...
	jobject jobj )
{
	...
	FD_ZERO(&rfds);while( !interrupted ) {
		FD_SET(fd, &rfds);
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
void send_modem_events(JNIEnv *env, jobject jobj, jmethodID method, int event,
...
#if defined(__linux__)
if (!strcmp(name, "tty0") || !strcmp(name, "ttyd") || !strcmp(name, "ttyq")
	|| !strcmp(name, "ttym") || !strcmp(name, "ttyf")
	|| !strcmp(name, "cuaa")) {
#ifdef DEBUG
...
JNIEXPORT jint JNICALL Java_gnu_io_RawPort_getInputBufferSize(JNIEnv *env,
jobject jobj) {
#ifdef DEBUG
...
JNIEXPORT jint JNICALL Java_gnu_io_RawPort_getOutputBufferSize(JNIEnv *env,
jobject jobj) {
#ifdef DEBUG
