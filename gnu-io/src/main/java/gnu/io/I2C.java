...
final class I2C extends I2CPort {
    ...
    private native void nativeSetI2CPortParams(int speed, int dataBits, int stopBits, int parity)
    ...
    public void sendEvent(int event, boolean state) {
        ...
        case I2CPortEvent.OUTPUT_BUFFER_EMPTY:
            ...
            return;
        /*
         * if( monThread.DSR ) break; return; if (isDSR()) { if (!dsrFlag) { dsrFlag = true; I2CPortEvent e = new
         * I2CPortEvent(this, I2CPortEvent.DSR, !dsrFlag, dsrFlag ); } } else if (dsrFlag) { dsrFlag = false;
    ...
    class I2CInputStream extends InputStream {
        ...
        public int read(byte b[], int off, int len) throws IOException {
             ...
             * NativeEnableReceiveTimeoutThreshold in I2CImp.c
             */
    ...
    class MonitorThread extends Thread {
        /**
         * Note: these have to be separate boolean flags because the I2CPortEvent constants are NOT bit-flags, they are
