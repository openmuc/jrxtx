...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL LPRPort(getOutputBufferFree)(JNIEnv *env, jclass jclazz) {
...
/*----------------------------------------------------------
 ...
 comments:
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL LPRPort(setLPRMode)(JNIEnv *env, jclass jclazz,
		jint mode) {
	switch (mode) {
	case LPT_MODE_ANY:
		break;
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL LPRPort(isPaperOut)(JNIEnv *env, jobject jobj) {
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL LPRPort(isPrinterBusy)(JNIEnv *env, jobject jobj) {
	int fd = get_java_var(env, jobj, "fd", "I");
	int status;
#if defined (__linux__)
	ioctl(fd, LPGETSTATUS, &status);
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL LPRPort(isPrinterError)(JNIEnv *env, jobject jobj) {
	int fd = get_java_var(env, jobj, "fd", "I");
#if defined (__linux__)
	int status;
	ioctl(fd, LPGETSTATUS, &status);
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL LPRPort(isPrinterSelected)(JNIEnv *env, jobject jobj) {
	int fd = get_java_var(env, jobj, "fd", "I");
#if defined (__linux__)
	int status;
	ioctl(fd, LPGETSTATUS, &status);
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jboolean JNICALL LPRPort(isPrinterTimedOut)(JNIEnv *env, jobject jobj) {
#if defined(__linux__)
	int fd = get_java_var(env, jobj, "fd", "I");
	int status;
	ioctl(fd, LPGETSTATUS, &status);
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT void JNICALL LPRPort(Initialize)
( JNIEnv *env,
		jclass jclazz )
{
...
/*----------------------------------------------------------
 ...
 FIXME  Lock Files?
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL LPRPort(open)(JNIEnv *env, jobject jobj, jstring jstr) {
	...
	fail: throw_java_exception_system_msg(env, PORT_IN_USE_EXCEPTION, "open");
	return -1;
}
...
/*----------------------------------------------------------
 ...
 exceptions:  none
 ----------------------------------------------------------*/
JNIEXPORT void JNICALL LPRPort(nativeClose)
( JNIEnv *env,
	jobject jobj )
{
	int fd = get_java_var( env, jobj,"fd","I" );
...
----------------------------------------------------------*/
JNIEXPORT void JNICALL LPRPort(writeByte)
( JNIEnv *env,
...
/*----------------------------------------------------------
 ...
 exceptions:  IOException
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL LPRPort(readByte)(JNIEnv *env, jobject jobj) {
...
/*----------------------------------------------------------
 ...
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL LPRPort(readArray)(JNIEnv *env, jobject jobj,
	...
	if ((size_t) length < 1 || (size_t) length > SSIZE_MAX) {
		throw_java_exception(env, IO_EXCEPTION, "readArray", "Invalid length");
		return -1;
	}
...
/*----------------------------------------------------------
 ...
 exceptions:  none
 ----------------------------------------------------------*/
JNIEXPORT jint JNICALL LPRPort(nativeavailable)(JNIEnv *env, jobject jobj) {
	int fd = get_java_var(env, jobj, "fd", "I");
	int result;
	/*
	 char message[80];
...
/*----------------------------------------------------------
 ...
 exceptions:  IOException
 ----------------------------------------------------------*/
JNIEXPORT void JNICALL LPRPort(setHWFC)
( JNIEnv *env,
...
JNIEXPORT void JNICALL LPRPort(setInputBufferSize)
(JNIEnv *env,
...
JNIEXPORT jint JNICALL LPRPort(getInputBufferSize)(JNIEnv *env, jobject jobj) {
#ifdef DEBUG
	printf("getInputBufferSize is not implemented\n");
#endif
	return (1);
}
JNIEXPORT void JNICALL LPRPort(setOutputBufferSize)
(JNIEnv *env,
		jobject jobj, jint size )
{
#ifdef DEBUG
...
JNIEXPORT jint JNICALL LPRPort(getOutputBufferSize)(JNIEnv *env, jobject jobj) {
#ifdef DEBUG
